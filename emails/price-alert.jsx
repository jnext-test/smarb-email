  ...
  <Section>
    {[1, 2, 3].map((item, index) => (
      ...
      >
        ...
        {/* Bookmaker and Prices */}
        <Row style={priceContainer}>
          <Column>
            <Row>
              <Column style={priceItemColumn}>
                <Text style={priceLabel}>Trigger</Text>
                <div style={priceBox}>
                  <Text style={priceText}>{triggerPrice}</Text>
                </div>
              </Column>
              <Column style={arrowColumn}>
                <Text style={arrowStyle}>
                  <img
                    src={
                      "http://media.staging.smartb.au.sydney.digiground.com.au/uploads/1745402079898.png"
                    }
                    alt="Arrow Right"
                  />
                </Text>
              ...
              <Column style={priceItemColumn}>
                <Text style={priceLabel}>Current</Text>
                <div style={priceBox}>
